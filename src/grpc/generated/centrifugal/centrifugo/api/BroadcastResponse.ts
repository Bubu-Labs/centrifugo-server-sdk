...
export interface BroadcastResponse {
  ...
  'result'?: (_centrifugal_centrifugo_api_BroadcastResult | null);
}

export interface BroadcastResponse__Output {
  'error'?: (_centrifugal_centrifugo_api_Error__Output);
  'result'?: (_centrifugal_centrifugo_api_BroadcastResult__Output);
}
