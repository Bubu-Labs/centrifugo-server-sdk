...
export interface HistoryRemoveResponse {
  ...
  'result'?: (_centrifugal_centrifugo_api_HistoryRemoveResult | null);
}

export interface HistoryRemoveResponse__Output {
  'error'?: (_centrifugal_centrifugo_api_Error__Output);
  'result'?: (_centrifugal_centrifugo_api_HistoryRemoveResult__Output);
}
