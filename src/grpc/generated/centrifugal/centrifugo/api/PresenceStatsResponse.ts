...
export interface PresenceStatsResponse {
  ...
  'result'?: (_centrifugal_centrifugo_api_PresenceStatsResult | null);
}

export interface PresenceStatsResponse__Output {
  'error'?: (_centrifugal_centrifugo_api_Error__Output);
  'result'?: (_centrifugal_centrifugo_api_PresenceStatsResult__Output);
}
